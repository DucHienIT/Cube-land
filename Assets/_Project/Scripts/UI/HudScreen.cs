...
namespace CubeBlaster
{
    public class HudScreen : UIScreen
    {
        ...
        public HudScreen(UIController ui) : base(ui) { }
        ...
        public override void Build(RectTransform parent)
        {
            ...
            var menu = UIFactory.CandyButton("Menu", t, "≡", pal.btnSlate, () => UI.BackToMenu(), 56);
            UIFactory.Rect(menu.gameObject, new Vector2(0, 1), new Vector2(0, 1), new Vector2(40, -170), new Vector2(160, -60));

            var restart = UIFactory.CandyButton("Restart", t, "↻", pal.btnOrange, () => UI.Restart(), 56);
            ...
            // progress bar: dark glossy pill track + green glossy fill
            var track = new GameObject("Track", typeof(RectTransform), typeof(Image));
            track.transform.SetParent(t, false);
            ...
            trackImg.sprite = SpriteFactory.UIGloss();
            trackImg.type = Image.Type.Sliced;
            trackImg.color = new Color(0.10f, 0.13f, 0.22f, 0.85f);
            ...
            _bar.rectTransform.anchorMin = new Vector2(0, 0); _bar.rectTransform.anchorMax = new Vector2(1, 1);
            _bar.rectTransform.offsetMin = new Vector2(4, 4); _bar.rectTransform.offsetMax = new Vector2(-4, -4);

            _progress = UIFactory.Label("Prog", t, "", 34, Color.white);
        ...
        public void SetProgress(int alive, int total)
        {
            ...
            if (_bar != null)
            {
                ...
                _bar.enabled = destroyed > 0.03f; // sliced caps look broken at near-zero width
            }
